...
For information about using `expo-router/unstable-native-tabs` in Native tabs guide:

<BoxLink title="Native Tabs" Icon={BookOpen02Icon} href="/router/advanced/native-tabs/" />

## API

```js
import { NativeTabs, Icon, Label, Badge } from 'expo-router/ui';
```
